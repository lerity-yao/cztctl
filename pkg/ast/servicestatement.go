...
// CommentGroup
// CommentGroup todo something yaox
func (s *ServiceItemStmt) CommentGroup() (head, leading CommentGroup) {
	//_, leading = s.Route.CommentGroup()
	if s.AtDoc != nil {
		head, _ = s.AtDoc.CommentGroup()
	...
	//head, _ = s.AtHandler.CommentGroup()
	head, _ = s.AtListener.CommentGroup()
	return head, nil
}
...
// AtListenerStmt 新增
// AtListenerStmt todo something yaox
type AtListenerStmt struct {
	AtListener *TokenNode
	Name       *TokenNode
}

func (a *AtListenerStmt) CommentGroup() (head, leading CommentGroup) {
	return a.AtListener.HeadCommentGroup, a.Name.LeadingCommentGroup
}

// QueueStmt 新增
// QueueStmt todo something yaox
